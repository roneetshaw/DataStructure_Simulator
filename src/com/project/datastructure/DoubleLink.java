...
public class DoubleLink extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnLinkDel=(Button)findViewById(R.id.btnLinkDel1);
		btnLinkAdd=(Button)findViewById(R.id.btnLinkAdd1);
		node1=(TextView)findViewById(R.id.LinkNode11);node2=(TextView)findViewById(R.id.LinkNode12);
		node3=(TextView)findViewById(R.id.LinkNode13);node4=(TextView)findViewById(R.id.LinkNode14);
		node5=(TextView)findViewById(R.id.LinkNode15);node6=(TextView)findViewById(R.id.LinkNode16);
		right1=(ImageView)findViewById(R.id.imgarrow11);right2=(ImageView)findViewById(R.id.imgarrow12);
		right3=(ImageView)findViewById(R.id.imgarrow13);right4=(ImageView)findViewById(R.id.imgarrow14);
		right5=(ImageView)findViewById(R.id.imgarrow15);
		left1=(ImageView)findViewById(R.id.imgarrowLeft11);left2=(ImageView)findViewById(R.id.imgarrowLeft12);
		left3=(ImageView)findViewById(R.id.imgarrowLeft13);left4=(ImageView)findViewById(R.id.imgarrowLeft14);
		left5=(ImageView)findViewById(R.id.imgarrowLeft15);
	...
	public void ADD(View btnAdd)
	{
		...
		final RadioButton addB=new RadioButton(DoubleLink.this);
		...
		inputAdd.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(addB.isChecked())
				{
					AlertDialog.Builder addBeg=new AlertDialog.Builder(DoubleLink.this);
					addBeg.setTitle("ADD(BEGIN) ").setMessage("Enter a value ");
					final EditText value=new EditText(DoubleLink.this);
				...
				{
					AlertDialog.Builder addlast=new AlertDialog.Builder(DoubleLink.this);
				...
				{
					LayoutInflater factory = LayoutInflater.from(DoubleLink.this);
					...
					AlertDialog.Builder addPost=new AlertDialog.Builder(DoubleLink.this);
	...
	public void DELETE(View btnDel)
	{
		...
		inputDel.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(val.isChecked())
				{
					AlertDialog.Builder val_d=new AlertDialog.Builder(DoubleLink.this);
						...
						public void onClick(DialogInterface dialog, int which) 
						{
							if(value.getText().toString().length()!=0)
							{
									...
									if(search(del_val)==1)
									{
										...
										Toast.makeText(DoubleLink.this,"POSITION "+x1, Toast.LENGTH_SHORT).show();
										str[x1]="-99";
										shift(x1);
										redraw();
									}
				...
				{
					AlertDialog.Builder pos_d=new AlertDialog.Builder(DoubleLink.this);
					pos_d.setTitle("DELETE ").setMessage("ENTER POSITION ");
					final EditText position=new EditText(DoubleLink.this);
					position.setGravity(Gravity.CENTER);
	...
	public void DOCS(View btnDocs)
	{
		...
		link_doc.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(hi.isChecked())
				{
					CopyReadAssets("Double_Link_List_hi.pdf");
				}
				else if(en.isChecked())
				{
					CopyReadAssets("Double_Link_List_en.pdf");
				}
			}
		});
	...
	{
		Intent replyIntent =new Intent(this, DoubleLink.class);		
	...
	class linklist_b extends AsyncTask<String, Void ,String>
	{
		...
		protected void onPostExecute(String result) 
		{
			...
			if(result.compareTo("value")==0)
				Toast.makeText(DoubleLink.this,"ERROR in Value !!", Toast.LENGTH_SHORT).show();
			else if(result.compareTo("no")==0)
				Toast.makeText(DoubleLink.this,"Element not FOUND !!", Toast.LENGTH_LONG).show();
			else if(result.compareTo("event")==0)
				Toast.makeText(DoubleLink.this,"CLICK EVENT ERROR !!", Toast.LENGTH_LONG).show();
			else if(result.compareTo("position")==0)
				Toast.makeText(DoubleLink.this,"POSITION NOT VALID !!", Toast.LENGTH_LONG).show();
		}
	...
	public void callStack()
	{
		...
		inputStack.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(stack.isChecked())
				{
					Intent replyIntent =new Intent(DoubleLink.this, Stack_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dstack.isChecked())
				{
					Intent replyIntent1 =new Intent(DoubleLink.this, DualStack.class);
	...
	public void callQueue()
	{
		...
		inputQueue.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(fifo.isChecked())
				{
					Intent replyIntent =new Intent(DoubleLink.this, FifoQueue_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(Cqu.isChecked())
				{
					Intent replyIntent1 =new Intent(DoubleLink.this, CircularQueue_dr.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callSearch()
	{
		...
		impSearch.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				Intent i=new Intent(DoubleLink.this,LinearSearch.class);
				startActivity(i);
			}
		});
	...
	public void callSort()
	{
		...
		inputQueue.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(sortB.isChecked())
				{
					Intent replyIntent =new Intent(DoubleLink.this, BubbleSort1.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(sortS.isChecked())
				{
					Intent replyIntent1 =new Intent(DoubleLink.this, SelectionSort1.class);
					startActivityForResult(replyIntent1, 0);
				}
				else if(sortQ.isChecked())
				{
					Intent replyIntent2 =new Intent(DoubleLink.this, LinearSearch.class);
				...
				{
					Intent replyIntent2 =new Intent(DoubleLink.this, InsertionActivity.class);
					startActivityForResult(replyIntent2, 0);
				}
			}
		});
	...
	public void callTree()
	{
		...
		inputTree.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(bst.isChecked())
				{
					Intent replyIntent =new Intent(DoubleLink.this, Tree_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(avl.isChecked())
				{
					Intent replyIntent1 =new Intent(DoubleLink.this, AvlTree1.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});

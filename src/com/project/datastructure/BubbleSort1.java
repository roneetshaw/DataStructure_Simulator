...
public class BubbleSort1 extends Activity
{
	WebView wbBubble;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_bubble_sort1);
	...
	public void onClickSimulateB(View v)
	{
		Intent i=new Intent(this,BubbleSort3.class);
		startActivity(i);
	}
	...
	{	
		...
		link_doc2.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(hi.isChecked())
				{
					CopyReadAssets("Bubble_Sort_hi.pdf");
				}
				else if(en.isChecked())
				{
					CopyReadAssets("Bubble_Sort_en.pdf");
				}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.bubble_sort1, menu);
		return true;
	}
	...
	public void callStack()
	{
		...
		inputStack.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(stack.isChecked())
				{
					Intent replyIntent =new Intent(BubbleSort1.this, Stack_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dstack.isChecked())
				{
					Intent replyIntent1 =new Intent(BubbleSort1.this, DualStack.class);
	...
	public void callLink()
	{
		...
		inputLink.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(sll.isChecked())
				{
					Intent replyIntent =new Intent(BubbleSort1.this, LinkList_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dll.isChecked())
				{
					Intent replyIntent1 =new Intent(BubbleSort1.this, DoubleLink.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callSearch()
	{
		...
		impSearch.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				Intent i=new Intent(BubbleSort1.this,LinearSearch.class);
				startActivity(i);
			}
		});
	...
	public void callTree()
	{
		...
		inputTree.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(bst.isChecked())
				{
					Intent replyIntent =new Intent(BubbleSort1.this, Tree_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(avl.isChecked())
				{
					Intent replyIntent1 =new Intent(BubbleSort1.this, AvlTree1.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callQueue()
	{
		...
		inputQueue.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(fifo.isChecked())
				{
					Intent replyIntent =new Intent(BubbleSort1.this, FifoQueue_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(Cqu.isChecked())
				{
					Intent replyIntent1 =new Intent(BubbleSort1.this, CircularQueue_dr.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});

...
public class SelectionSort1 extends Activity
{
	WebView  wbSelect;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_selection_sort1);
		wbSelect=(WebView)findViewById(R.id.webViewselection);
		wbSelect.setVerticalScrollBarEnabled(false);
		wbSelect.setHorizontalScrollBarEnabled(false);
		wbSelect.getSettings().setJavaScriptEnabled(true);
		wbSelect.setOnTouchListener(new View.OnTouchListener()
		{
			@Override
        ...
        String URL="selectiongif.gif";
        String html = "<html><body><img src=\"" + URL + "\" width=\"100%\" height=\"100%\"\"/></body></html>";
        wbSelect.loadDataWithBaseURL("file:///android_asset/",html, "text/html","utf-8", null);
        wbSelect.setBackgroundResource(R.color.white);
        wbSelect.setBackgroundColor(0);
	}
	public void onClickSimulate(View v)
	{
		Intent i=new Intent(this,SelectionSort3.class);
		startActivity(i);
	}
	public void DOCS(View btnViewBubbleDocs)
	{	
		AlertDialog.Builder link_doc3=new AlertDialog.Builder(this);
		link_doc3.setTitle("Documentation").setMessage("Choose a type ");
		...
		link_doc3.setView(Qrg);
		link_doc3.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			@Override
			public void onClick(DialogInterface dialog, int which) 
			{
				if(hi.isChecked())
				{
					CopyReadAssets("Selection_Sort_hi.pdf");
				}
				else if(en.isChecked())
				{
					CopyReadAssets("Selection_Sort_en.pdf");
				}
			}
		});
		link_doc3.setNegativeButton("CANCEL",new DialogInterface.OnClickListener() 
		{
			@Override
			public void onClick(DialogInterface dialog, int which) 
			{
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.selection_sort1, menu);
		return true;
	}
	...
	public void callStack()
	{
		...
		inputStack.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(stack.isChecked())
				{
					Intent replyIntent =new Intent(SelectionSort1.this, Stack_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dstack.isChecked())
				{
					Intent replyIntent1 =new Intent(SelectionSort1.this, DualStack.class);
	...
	public void callLink()
	{
		...
		inputLink.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(sll.isChecked())
				{
					Intent replyIntent =new Intent(SelectionSort1.this, LinkList_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dll.isChecked())
				{
					Intent replyIntent1 =new Intent(SelectionSort1.this, DoubleLink.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callSearch()
	{
		...
		impSearch.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				Intent i=new Intent(SelectionSort1.this,LinearSearch.class);
				startActivity(i);
			}
		});
	...
	public void callQueue()
	{
		...
		inputQueue.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(fifo.isChecked())
				{
					Intent replyIntent =new Intent(SelectionSort1.this, FifoQueue_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(Cqu.isChecked())
				{
					Intent replyIntent1 =new Intent(SelectionSort1.this, CircularQueue_dr.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callTree()
	{
		...
		inputTree.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(bst.isChecked())
				{
					Intent replyIntent =new Intent(SelectionSort1.this, Tree_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(avl.isChecked())
				{
					Intent replyIntent1 =new Intent(SelectionSort1.this, AvlTree1.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});

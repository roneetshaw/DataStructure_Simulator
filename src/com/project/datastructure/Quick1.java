...
public class Quick1 extends Activity {

	WebView wbBubble;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_quick1);
	...
	{
		Intent replyIntent =new Intent(this, QuickSort.class);
	...
	{	
		...
		link_doc2.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(hi.isChecked())
				{
					CopyReadAssets("Quick_Sort_hi.pdf");
				}
				else if(en.isChecked())
				{
					CopyReadAssets("Quick_Sort_en.pdf");
				}
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.quick1, menu);
		return true;
	}
	...
	public void callStack()
	{
		...
		inputStack.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(stack.isChecked())
				{
					Intent replyIntent =new Intent(Quick1.this, Stack_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dstack.isChecked())
				{
					Intent replyIntent1 =new Intent(Quick1.this, DualStack.class);
	...
	public void callLink()
	{
		...
		inputLink.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(sll.isChecked())
				{
					Intent replyIntent =new Intent(Quick1.this, LinkList_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(dll.isChecked())
				{
					Intent replyIntent1 =new Intent(Quick1.this, DoubleLink.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callSearch()
	{
		...
		impSearch.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				Intent i=new Intent(Quick1.this,LinearSearch.class);
				startActivity(i);
			}
		});
	...
	public void callTree()
	{
		...
		inputTree.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(bst.isChecked())
				{
					Intent replyIntent =new Intent(Quick1.this, Tree_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(avl.isChecked())
				{
					Intent replyIntent1 =new Intent(Quick1.this, AvlTree1.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
	...
	public void callQueue()
	{
		...
		inputQueue.setPositiveButton("OK",new DialogInterface.OnClickListener() 
		{
			...
			public void onClick(DialogInterface dialog, int which) 
			{
				if(fifo.isChecked())
				{
					Intent replyIntent =new Intent(Quick1.this, FifoQueue_dr.class);
					startActivityForResult(replyIntent, 0);
				}
				else if(Cqu.isChecked())
				{
					Intent replyIntent1 =new Intent(Quick1.this, CircularQueue_dr.class);
					startActivityForResult(replyIntent1, 0);
				}
			}
		});
